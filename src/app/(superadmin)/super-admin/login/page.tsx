...
const formSchema = z.object({
  email: z.string().email({ message: "Por favor, insira um endereco de e-mail valido." }),
...
export default function SuperAdminLoginPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    if (!isSuperAdminEmail(values.email)) {
      toast({
        variant: "destructive",
        title: "Acesso negado",
        description: "Este e-mail nao tem permissao para acessar o dashboard Super Admin.",
      });
      return;
    }
    ...
    try {
      ...
      if (user.role !== "SUPERADMIN") {
        toast({
          variant: "destructive",
          title: "Acesso negado",
          description: "Este usuario nao tem permissoes de super admin.",
        });
        return;
      }
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="claudiohs@hotmail.com" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
